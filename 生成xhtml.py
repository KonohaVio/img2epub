...
class Application(tk.Frame):
    ...
    def create_widgets(self):
        ...
        self.text = tk.Label(self,text="输入文件路径")
        self.text.pack(side="top")
        # 显示文件路径
        self.filePath_en = tk.Entry(self,width = 140)
        self.filePath_en.pack(side="top")
        
        self.getFile_bt_cv = tk.Button(self)
        self.getFile_bt_cv['width'] = 15
        self.getFile_bt_cv['height'] = 1
        self.getFile_bt_cv["text"] = "按路径生成"
        self.getFile_bt_cv["command"] = self._getFile_cv
        self.getFile_bt_cv.pack(side="top")
    ...
    # 打开文件并显示路径
    def _getFile_cv(self):       
        self.filePath = self.filePath_en.get()
        print(self.filePath)        
        self._createHTML()
